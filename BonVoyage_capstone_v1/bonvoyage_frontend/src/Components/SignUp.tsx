    ...
    return (
        ...
        <Header></Header>
            ...
            <div className="container">
                ...
                <Grid lg={6} style={{paddingLeft:'150px'}}>
                <h2>Sign Up</h2>
                <form onSubmit={handleSubmit}>
                    ...
                    <br></br>
                    <div className="form-group">
                        <TextField id="outlined-basic" className="form-control" name="userEmail" type='email' required label="Email" variant="outlined"  inputProps={{
...
,
        ...
        pattern: "[0-9]{10}", 
                    ...
                    <div className="form-group">
                        ...
                        <FormControl sx={{ m: 0, width: '28ch' }} variant="filled">
